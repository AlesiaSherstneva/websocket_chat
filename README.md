...
<p>Также можно запустить чат через командную строку:  java -jar server.jar </p>
...
<p>Использованные технологии: Java SE, Java EE, Jetty, Maven, a little of HTML & JavaScript.<p>
![img.png](img.png)
![img_1.png](img_1.png)
![img_2.png](img_2.png)